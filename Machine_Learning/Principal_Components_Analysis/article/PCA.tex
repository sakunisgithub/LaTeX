...
\subsection{Interpretation 1 : Obtaining new High Variance-Low Covariance Representation}
...
\subsection{Interpretation 2 : Minimizing Projection Residuals}
...
\subsection{Interpretation 3 : Maximizing Variance}

Refer to CS229 Lecture Notes. \\[0.2em]

$\spadesuit$ A short discussion on variance of the principal components : We started off with the following wishlist. \\
