...
%12
	\item Analyse the following $2^3$ completely confounded factorial design.
...
%14
	\item For a Factorial Experiment with $3$ factors $N$, $K$, $P$ each at two levels, the design and yield per plot are given below. Analyse the data.
