...
%14
	\item Let $X_1$, $X_2$, \ldots, $X_{10}$ be a random sample of size 10 drawn from a $N(\mu, \sigma^2)$ population, where $\sigma$ is known. Use the method of likelihood ratio testing to develop a critical region with size $\alpha = 0.05$ for testing the null hypothesis $H_0 : \mu = 1$ against the alternative hypothesis $H_1 : \mu \neq 1$.
\end{enumerate}
\end{document}