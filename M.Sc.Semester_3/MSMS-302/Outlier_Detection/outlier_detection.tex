...
\item Collective Outlier : A group of data points that are unusual together. If they are studied isolated, they may not be outliers. For example, sudden spike in server activity during midnight.
\end{enumerate}
...
\item Local Outlier Factor (LOF) : LOF measures how isolated a point is related to its neighbourhoods. In this method,
\begin{itemize}
